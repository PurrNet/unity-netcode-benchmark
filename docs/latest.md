...
|---|---:|---:|---:|---:|---:|---:|
| PurrNet | Completed | **1.79 MB/s** | 7.4% | 589 KB/s | 1 | **16.7 ms** |
| FishNet | Completed | 2.52 MB/s | **6.3%** | 738 KB/s | 27 | 17.4 ms |
| Mirror | Completed | 4.12 MB/s | 12.6% | 3.13 MB/s | 23 | **16.7 ms** |
| NGO | Completed | 5.00 MB/s | 75.1% | **1.3 KB/s** | **0** | 47.6 ms |
| Fusion | Completed | 3.50 MB/s | 21.5% | 1.01 MB/s | 16 | **16.7 ms** |

**Messaging** (100 connections @ 20 Hz · SendRPC, ClientInput)

| Netcode | Status | Bandwidth | Server CPU | GC alloc | Collections | Frame p99 |
|---|---:|---:|---:|---:|---:|---:|
| PurrNet | Completed | 935 KB/s | **5.9%** | 671 KB/s | **1** | **16.7 ms** |
| FishNet | Completed | **770 KB/s** | 7.3% | 848 KB/s | 28 | 17.6 ms |
| Mirror | Completed | 1.63 MB/s | 11.8% | 3.67 MB/s | 18 | **16.7 ms** |
| NGO | Completed | 1.82 MB/s | 38.2% | **48.3 KB/s** | **1** | 40.9 ms |
| Fusion | Completed | 1.98 MB/s | 12.8% | 929 KB/s | 4 | **16.7 ms** |

**Spawn / despawn** (100 connections @ 20 Hz · SpawnChurn)

| Netcode | Status | Bandwidth | Server CPU | GC alloc | Collections | Frame p99 |
|---|---:|---:|---:|---:|---:|---:|
| PurrNet | Completed | 775 KB/s | 14.0% | 3.18 MB/s | 3 | **16.7 ms** |
| FishNet | Completed | 640 KB/s | **7.8%** | 1.49 MB/s | 22 | 17.6 ms |
| Mirror | Completed | 856 KB/s | 9.4% | 4.60 MB/s | 12 | **16.7 ms** |
| NGO | Completed | 2.10 MB/s | 11.2% | 1.03 MB/s | 10 | **16.7 ms** |
| Fusion | Completed | **625 KB/s** | 11.6% | **424 KB/s** | **2** | **16.7 ms** |
...
| NGO | 34.1 KB/s | 0.525 pts | **31.9 KB/s** | 0.488 pts |
| Fusion | 25.7 KB/s | 0.135 pts | 139 KB/s | 1.20 pts |
